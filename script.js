const checkStatus = (response) => {
  ...
  class ToDoList extends React.Component {
    ...
    fetchTasks() {
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=284")
        .then(checkStatus)
        .then(json)
        .then((response) => {
    ...
    deleteTask(id) {
      ...
      fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=284`, {
        method: "DELETE",
        mode: "cors",
      }).then(checkStatus)
        .then(json)
    ...
    toggleComplete(id, completed) {
      ...
      fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=284`, {
        method: "PUT",
        mode: "cors",
      }).then(checkStatus)
        .then(json)
